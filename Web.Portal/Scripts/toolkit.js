...
var TTMS = window.TTMS || {};

/*响应操作消息相关功能
@info：操作的详细描述
@title：标题描述
 */
TTMS.Msg = new function () {
...
TTMS.Path = new function () {
    ...
    self.url = function (controllerName, actionName, areaName) {
        ...
        if (url == "") {
            TTMS.Msg.showError("没有找到路径:area:" + areaName + ",controller:" + controllerName, "action:" + actionName);
        }
        return url;
    }
};
